                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        ...
                        if (location != null) {
                            ...
                            try {
                                ...
                                t1.setText(Html.fromHtml("<font color='#0059D4'><b>Latitude</b><br></font>" + addresses.get(0).getLatitude()));

                                // Set  longitude on Textview
                                t2.setText(Html.fromHtml("<font color='#0059D4'><b>Longitude</b><br></font>" + addresses.get(0).getLongitude()));

                                // Set  Country name on Textview
                                t3.setText(Html.fromHtml("<font color='#0059D4'><b>Country:</b><br></font>" + addresses.get(0).getCountryName()));

                                // Set  locality on Textview
                                t4.setText(Html.fromHtml("<font color='#0059D4'><b>Locality:</b><br></font>" + addresses.get(0).getLocality()));

                                // Set  latitude on Textview
                                t5.setText(Html.fromHtml("<font color='#0059D4'><b>Address:</b><br></font>" + addresses.get(0).getAddressLine(0)));

                                // Set  latitude on Textview
                                t6.setText(Html.fromHtml("<font color='#0059D4'><b></b><br></font>" + addresses.get(0).getLatitude()));

                                // Set  longitude on Textview
                                t7.setText(Html.fromHtml("<font color='#0059D4'><b></b><br></font>" + addresses.get(0).getLongitude()));
