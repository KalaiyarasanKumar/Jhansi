...
public class ContactFragment extends Fragment {
    ...
    public void onDataChange() {
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId);
    ...
    ItemTouchHelper.SimpleCallback itemTouchHelper = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT | ItemTouchHelper.LEFT) {
        ...
        public void onSwiped(@NonNull final RecyclerView.ViewHolder viewHolder, int direction) {
            ...
            ca.notifyDataSetChanged();
            onDataChange();
            Snackbar snackbar = Snackbar.make(getActivity().findViewById(android.R.id.content), "You just deleted a contact", BaseTransientBottomBar.LENGTH_LONG);
